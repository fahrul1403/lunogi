...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (pathname === '/products/sports/Sports-research-daily-probiotics-with-probiotics') {
        detail = {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    } else if (pathname === '/products/sports/Apple-MacBook-Laptop-11‑core-14‑core') {
    detail = {
        ...
        <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col order-2 md:order-1 basis-3/4 overflow-y-auto overscroll-contain h-[650px]">
                            <div className="p-5 mx-auto text-black text-center w-full">            
                                ...
                                This is a categoty for sports
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                                    {detail.features.map((feature, index) => (
                                        <div key={index} className="border-4 border-blue-600 rounded-xl flex flex-col h-full">
                                            <div className="flex flex-col h-full">
                                                <div className="flex justify-center items-center p-5 h-64"> {/* Fixed height for image container */}
                                                    <Image 
                                                        src={detail.images[index] || '/placeholder-image.jpg'} 
                                                        alt={`image for ${feature}`} 
                                                        width={200} 
                                                        height={200}
                                                ...
                                                <div className="flex flex-col flex-grow">
                                                    <div className="font-bold text-2xl text-white bg-gradient-to-b from-blue-600 to-blue-800 p-5">{feature}</div>
                                                    <div className="mt-2 flex-grow p-5">{detail.descriptions[index]}</div>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
...
{/*---------------------------------------------------------------------------------------------------------------------------------------------*/}
                    ...
                    <div className="order-1 md:order-2 md:basis-1/4 flex flex-col items-center overflow-y-auto overscroll-contain h-[550px]">
                        ...
                        <div className="p-5 mx-10">
                            ...
                            <StarIcon className="w-10 h-10 fill-yellow-500 text-yellow-500" />
                            <StarIcon className="w-10 h-10 fill-yellow-500 text-yellow-500" />
                            <StarIcon className="w-10 h-10 fill-yellow-500 text-yellow-500" />
                            <StarIcon className="w-10 h-10 fill-yellow-500 text-yellow-500" />
                            <StarIcon className="w-10 h-10 fill-yellow-500 text-yellow-500" />
