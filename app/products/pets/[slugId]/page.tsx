...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (pathname === '/products/pets/Sports-research-daily-probiotics-with-probiotics') {
        detail = {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    } else if (pathname === '/products/pets/Apple-MacBook-Laptop-11‑core-14‑core') {
    detail = {
...
} else if (pathname === '/products/pets/bundle-of-bissell-little-green-pet-deluxe-portable-carpet-cleaner-and-car-auto-detailer') {
    detail = {
        features: [
            'PORTABLE CLEANING',
            'PET STAIN REMOVAL',
        ...
        descriptions: [
            ...
            'Specially formulated to tackle tough pet stains and odors.',
            'Strong suction power for effective dirt and liquid extraction.',
            'Suitable for carpets, upholstery, car interiors, and more.',
            'Includes additional tools for detailed car interior cleaning.'
        ],
        images: [
            '/Bundle of bissel.jpeg',
            '/Bundle of bissel.jpeg',
            '/Bundle of bissel.jpeg',
            '/Bundle of bissel.jpeg',
            '/Bundle of bissel.jpeg',
        ...
        options: [
            {
                colorbutton: '',
                textbutton: '',
                subtitle: 'Bissell Little Green Pet Deluxe Bundle',
                imageset: [
                    '/Bundle of bissel.jpeg',
                ],
                link: 'https://amzn.to/3MtSwCU'
            },
        ],
        description: '',
        breadcumb: 'Bundle of Bissell Little Green Pet Deluxe Portable Carpet Cleaner and Car/Auto Detailer',
        title: 'Bissell Little Green Pet Deluxe Bundle',
        price: '$120.00',
        video: '',
        specs: [
            'Product Information',
        ...
        values: [
            {
                ...
                content: [
                    ...
                    { label: 'Model', value: 'Little Green Pet Deluxe' },
            ...
            {
                type: 'text',
                content: 'Dimensions and weight not specified in the provided information.'
            },
            {
                type: 'list',
                content: [
                    'Portable and lightweight design',
                    'Specialized for pet stain and odor removal',
                    'Powerful suction for effective cleaning',
                    'Suitable for multiple surfaces',
                    'Includes car detailing tools',
...
} else if (pathname === '/products/pets/Amazon-Basics-Dog-Poop-Bags-with-Dispenser-and-Leash-Clip') {
    detail = {
        features: [
            'CONVENIENT',
            'LEAK-PROOF',
        ...
        descriptions: [
            '300 bags (20 rolls) of 13 x 9 inch bags for cleaning up after dogs',
            'Made of strong, leak-proof plastic to contain messes',
            'Includes a dispenser with a clip that can be attached to a leash',
            'Bags are unscented for those sensitive to fragrances',
            'Bags are not biodegradable, but are made with recycled materials'
        ],
        images: [
            '/Amazon Basics Dog Poop Bags with Dispenser and Leash Clip. 13 x 9 Inches. Unscented. Black - 300 Bags (20 Rolls)-1.jpg',
            '/Amazon Basics Dog Poop Bags with Dispenser and Leash Clip. 13 x 9 Inches. Unscented. Black - 300 Bags (20 Rolls)-2.jpg',
            '/Amazon Basics Dog Poop Bags with Dispenser and Leash Clip. 13 x 9 Inches. Unscented. Black - 300 Bags (20 Rolls)-3.jpg',
            '/Amazon Basics Dog Poop Bags with Dispenser and Leash Clip. 13 x 9 Inches. Unscented. Black - 300 Bags (20 Rolls)-4.jpg',
            '/Amazon Basics Dog Poop Bags with Dispenser and Leash Clip. 13 x 9 Inches. Unscented. Black - 300 Bags (20 Rolls)-5.jpg',
        ],
        carousel_feature: [],
        carousel_feature_images: [],
        carousel_desc: [],
        options: [
            {
                ...
                link: 'https://amzn.to/47kAe0L'
            },
        ],
        description: '',
        breadcumb: 'Amazon Basics Dog Poop Bags with Dispenser and Leash Clip',
        title: 'Amazon Basics Dog Poop Bags',
        price: '$8.68',
        video: '',
        specs: [
            'Product Information',
        ...
        values: [
            {
                ...
                content: [
                    ...
                    { label: 'Item Count', value: '300 Count' }
                ]
            },
            {
                type: 'table',
                content: [
                    ...
                    { label: 'Item Weight', value: '1.65 Pounds' },
                    { label: 'Number of Rolls', value: '20' }
                ]
            },
            {
                type: 'list',
                content: [
                    'Includes dispenser with leash clip',
        ...
        <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col order-2 md:order-1 basis-3/4 overflow-y-auto overscroll-contain h-[650px]">
                            <div className="p-5 mx-auto text-black text-center w-full">            
                                ...
                                This is a categoty for pets

                                <div className="flex flex-col self-center w-11/12 mx-10">
                                    {Array.from({ length: Math.ceil(detail.features.length / 3) }).map((_, rowIndex) => (
                                        <div key={rowIndex} className={`flex my-4 ${rowIndex % 2 === 0 ? 'bg-gray-300 rounded-3xl shadow-xl' : 'bg-slate-200 rounded-3xl shadow-xl'}`}>
                                            {[0, 1, 2].map((colIndex) => {
                                                const index = rowIndex * 3 + colIndex;
                                                if (index >= detail.features.length) return null;
                                                return (
                                                    <div key={colIndex} className="basis-1/3 text-center flex flex-col">
                                                        <div className="flex justify-center items-center p-5 h-64"> {/* Fixed height */}
                                                            {detail.images[index] && (
                                                                <Image 
                                                        ...
                                                        <div className="flex flex-col mb-5 px-2 flex-grow"> {/* Added flex-grow */}
                                                            <div className="font-bold text-2xl mb-2">{detail.features[index]}</div>
                                                            <div className="text-base">{detail.descriptions[index]}</div>
                                                        </div>
                                                    </div>
                                                );
                                            })}
